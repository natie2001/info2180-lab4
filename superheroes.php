...
$superheroes = [
    ...
    ["id"=>10,"name"=>"Wanda Maximoff","alias"=>"Scarlet Witch","biography"=>"Notably powerful, Wanda Maximoff has fought both against and with the Avengers, attempting to hone her abilities and do what she believes is right to help the world."]
];
